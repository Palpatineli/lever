...
from lever.script.steps.behavior import res_lever_shape, res_delay_hitrate
...
def main():
    graph = to_nx([res_classifier_power, res_lever_shape, res_delay_hitrate, res_decode_power, res_neuron_info,
                   res_encoding])
